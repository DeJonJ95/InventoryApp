...
/**
 * Find the most recent PAMS export (.xlsx) in Storage and return a
 * temporary, downloadable URL for it.
 *
 * Filenames are pams_sync_YYYY-MM-DD.xlsx, so lexical sort ==
 * chronological sort — the greatest name is the newest export. (Any
 * legacy .csv files sort below the same-date .xlsx, so the xlsx wins.)
 *
